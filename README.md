...
Файл exe був створений за допомогою пакету PyInstaller. Для його створення виконайте наступні команди:

pip install pyinstaller
pyinstaller -F guess_the_number.py

Ці команди встановлять пакет PyInstaller і створять exe файл під назвою "guess_the_number.exe" в поточному каталозі.
